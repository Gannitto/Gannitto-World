			...
			"Objects": (
				{
					...
					"Template": {
						"name": "Pond",
						"image_path": "assets/Images/Objects/Pond.png",
						"scale_x": (512, 512),
				...
				},
				{
					...
					"Template": {
						"name": "Reed",
						"image_path": "assets/Images/Objects/Reed.png",
						"scale_x": (256, 256)
						}
				}
			   ),
...
biomes_objects = {
		...
		"Desert": {
			"Objects": (
				(1, {
					"name": "Cactus",
					"image_path": "assets/Images/Objects/Cactus.png",
					"scale_x": (256, 256),
					"is_solid": True,
					"rect": (-80, 116, 160, 232)
					}),
				(0.5, {
					"name": "Pile of sand",
					"image_path": "assets/Images/Objects/Pile of sand.png",
					"scale_x": (256, 256),
					})),
			"Items": (),
			"Structures": ()},
		...
		"Forest": {
			"Objects": (
				...
				(2, {
					"name": "Birch",
					"image_path": "assets/Images/Objects/Birch.png",
					"scale_x": (256, 256),
					"special_flags": 100,
					"is_solid": True
					}),
				(0.5, {
					"name": "Bush",
					"image_path": "assets/Images/Objects/Bush.png",
					"scale_x": (128, 128),
					"is_solid": True
				})),
			"Items": (
				(0.3, {
					"name": "Stone",
					"image_path": "assets/Images/Items/Stone.png",
					}),
				(0.3, {
					"name": "Poppy",
					"image_path": "assets/Images/Items/Poppy.png",
					}),
				(0.3, {
					"name": "Purple tulip",
					"image_path": "assets/Images/Items/Purple tulip.png",
					}),
				(0.3, {
					"name": "Orange tulip",
					"image_path": "assets/Images/Items/Orange tulip.png",
					}),
				(0.3, {
					"name": "Purple tulip",
					"image_path": "assets/Images/Items/Purple tulip.png",
				...
				(0.3, {
					"name": "Black tulip",
					"image_path": "assets/Images/Items/Black tulip.png",
					}),
				(0.3, {
					"name": "Red tulip",
					"image_path": "assets/Images/Items/Red tulip.png",
					}),
				(0.3, {
					"name": "Yellow tulip",
					"image_path": "assets/Images/Items/Yellow tulip.png",
					}),
				(0.1, {
					"name": "Dandelion",
					"image_path": "assets/Images/Objects/Dandelion 1.png",
					}),
				(0.1, {
					"name": "Mushroom",
				...
				(0.1, {
					"name": "Red mushroom",
					"image_path": "assets/Images/Items/Red mushroom.png",
				})),
		...
		"Swamp": {
			"Objects": (
				(2, {
					"name": "Dark tree",
					"image_path": "assets/Images/Objects/Dark tree.png",
					"scale_x": (256, 256),
					"special_flags": 100,
					"is_solid": True}),),
			"Items": (
				(0.5, {
					"name": "Cotton grass",
					"image_path": "assets/Images/Items/Cotton grass.png",
					}),
				(0.5, {
					"name": "Mushroom",
					"image_path": "assets/Images/Items/Mushroom.png",
		...
		"Taiga": {
			"Objects": (
				(2, {
					"name": "Spruce",
					"image_path": "assets/Images/Objects/Spruce.png",
					"scale_x": (512, 512),
					"special_flags": 100,
					"is_solid": True
					}),
				(0.5, {
					"name": "Dark bush",
					"image_path": "assets/Images/Objects/Dark bush.png",
					"scale_x": (128, 128),
					"is_solid": True
				})),
			"Items": (),
