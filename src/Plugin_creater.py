...
class Button:
	...
	def main(self, action=None):
		...
		if self.x - self.w / 2 < mouse_x < self.x + self.w / 2 and self.y - self.h / 2 < mouse_y < self.y + self.h / 2:
			...
			if click[0] == 1:
				time.sleep(0.1)
				pygame.mixer.Sound.play(pygame.mixer.Sound(path + "assets/Sounds/Button Pressed.mp3"))
					...
					match i[0]:
						case "Item":
							try:
								...
								win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/No-file texture.png"), (64, 64)), (textInfo.size(i[0])[0] + 100, 50 + a * 94))
...
def upload_plugin():
	...
	page_back_button = Button(74, Height - 74, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)), win)
	page_next_button = Button(Width - 74, Height - 74, pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), True, False), pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)), True, False), win)
	page = 1
