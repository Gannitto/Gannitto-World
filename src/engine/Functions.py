...
def languages(Russian: str, English: str, Kazach: str) -> str:
	from config.Globals import changed_language
...
def text(text: str, text_x: int, text_y: int, color: tuple=text_color, size: int=20, alignment: bool=False, letter_spasing: int=10, surface: pygame.Surface=win, max_width: int=0, max_height: int=0, return_surface: bool=False, spase_between_strings: int=10):
	...
	temp_font = pygame.font.Font(path + "assets/Font.ttf", size)
...
def win_darken(screen: pygame.Surface):
	...
	"""
	from config.Globals import win, clock
...
def win_lighten(screen: pygame.Surface, start_dark: int=300):
	...
	from config.Globals import clock, win
	from main import save
...
def draw_key(key: str, X: int, Y: int):
	...
	Y - y клавиши
	"""
	from config.Globals import win, bigTextInfo
...
mouse_click_images = (
	 pygame.transform.scale(pygame.image.load(path + "assets/Images/Mouse click 1.png"), (128, 128)),
	 pygame.transform.scale(pygame.image.load(path + "assets/Images/Mouse click 2.png"), (128, 128)),
	 pygame.transform.scale(pygame.image.load(path + "assets/Images/Mouse click 3.png"), (128, 128)),
	 pygame.transform.scale(pygame.image.load(path + "assets/Images/Mouse click 4.png"), (128, 128)),
	 pygame.transform.scale(pygame.image.load(path + "assets/Images/Mouse click 5.png"), (128, 128))
	 )
