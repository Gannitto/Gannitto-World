...
pygame.display.set_icon(pygame.image.load(path + "assets/Images/Icon.png"))
pygame.display.set_caption("Gannitto World")

Hiro_down_run_1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down/1.png"), (256, 256))
Hiro_down_run_2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down/2.png"), (256, 256))
Hiro_down_run_3 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down/3.png"), (256, 256))
Hiro_down_run_4 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down/4.png"), (256, 256))
Hiro_down_run_5 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down/5.png"), (256, 256))
Hiro_down_run_6 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down/6.png"), (256, 256))

Hiro_down_left = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down-left/1.png"), (256, 256))
Hiro_down_right = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Down-right/1.png"), (256, 256))

Hiro_left_run_1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Left/1.png"), (256, 256))
Hiro_left_run_2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Left/2.png"), (256, 256))
Hiro_left_run_3 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Left/3.png"), (256, 256))
Hiro_left_run_4 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Left/4.png"), (256, 256))
Hiro_left_run_5 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Left/5.png"), (256, 256))
Hiro_left_run_6 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Left/6.png"), (256, 256))

Hiro_right_run_1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Right/1.png"), (256, 256))
Hiro_right_run_2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Right/2.png"), (256, 256))
Hiro_right_run_3 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Right/3.png"), (256, 256))
Hiro_right_run_4 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Right/4.png"), (256, 256))
Hiro_right_run_5 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Right/5.png"), (256, 256))
Hiro_right_run_6 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Right/6.png"), (256, 256))

Hiro_up_run_1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up/1.png"), (256, 256))
Hiro_up_run_2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up/2.png"), (256, 256))
Hiro_up_run_3 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up/3.png"), (256, 256))
Hiro_up_run_4 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up/4.png"), (256, 256))
Hiro_up_run_5 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up/5.png"), (256, 256))
Hiro_up_run_6 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up/6.png"), (256, 256))

Hiro_up_left = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up-left/1.png"), (256, 256))

Hiro_up_right_run_1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Players/Hiro/Normal/Up-right/1.png"), (256, 256))

Hiro = Hiro_down_run_1
Hiro_rect = Hiro.get_rect(center=(Width / 2, Height / 2))

arrow_down = pygame.transform.scale(pygame.image.load(path + "assets/Images/DOWN.png"), (64, 64))
arrow_left = pygame.transform.scale(pygame.image.load(path + "assets/Images/LEFT.png"), (64, 64))
arrow_right = pygame.transform.scale(pygame.image.load(path + "assets/Images/RIGHT.png"), (64, 64))
arrow_up = pygame.transform.scale(pygame.image.load(path + "assets/Images/UP.png"), (64, 64))

Inventory_slot = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Inventory slot.png"), (64, 64))
Changed_inventory_slot = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Inventory slot 2.png"), (64, 64))

Craft_list_inventory_slot = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Craft list slot.png"), (64, 64))
Changed_craft_list_inventory_slot = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Craft list slot 2.png"), (64, 64))

Object_inventory_slot = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Object inventory slot 2.png"), (64, 64))

Tool_inventory_slot = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Tool inventory slot 2.png"), (64, 64))

Split_items1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Split items.png"), (64, 64))
Split_items2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Split items 2.png"), (64, 64))

Compact_inventory1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Compact inventory.png"), (64, 64))
Compact_inventory2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Compact inventory 2.png"), (64, 64))

Craft_list_slot1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Craft list slot.png"), (64, 64))
Craft_list_slot2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Craft list slot 2.png"), (64, 64))

Game_menu_slot1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Game menu slot.png"), (64, 64))
Game_menu_slot2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Game menu slot 2.png"), (64, 64))

Menu_slot1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Menu slot.png"), (64, 64))
Menu_slot2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Menu slot 2.png"), (64, 64))

Multyplayer_slot1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Multyplayer slot.png"), (64, 64))
Multyplayer_slot2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Multyplayer slot 2.png"), (64, 64))

Close_slot1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Close slot.png"), (64, 64))
Close_slot2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Close slot 2.png"), (64, 64))

Reference_slot1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Reference slot.png"), (64, 64))
Reference_slot2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Reference slot 2.png"), (64, 64))
...
Portal_1 = pygame.image.load(path + "assets/Images/Objects/Portal 1.png")
Portal_1 = pygame.transform.scale(Portal_1, (128, 256))
Portal_2 = pygame.image.load(path + "assets/Images/Objects/Portal 2.png")
Portal_2 = pygame.transform.scale(Portal_2, (128, 256))

Vending_machine_image = pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Vending machine.png"), (304, 560))

Wire_1 = pygame.image.load(path + "assets/Images/Objects/Wire 1.png")
Wire_1 = pygame.transform.scale(Wire_1, (64, 64))
Wire_2 = pygame.image.load(path + "assets/Images/Objects/Wire 2.png")
Wire_2 = pygame.transform.scale(Wire_2, (64, 64))
Wire_3 = pygame.image.load(path + "assets/Images/Objects/Wire 3.png")
Wire_3 = pygame.transform.scale(Wire_3, (64, 64))
Wire_4 = pygame.image.load(path + "assets/Images/Objects/Wire 4.png")
Wire_4 = pygame.transform.scale(Wire_4, (64, 64))
Wire_5 = pygame.image.load(path + "assets/Images/Objects/Wire 5.png")
Wire_5 = pygame.transform.scale(Wire_5, (64, 64))
Wire_6 = pygame.image.load(path + "assets/Images/Objects/Wire 6.png")
Wire_6 = pygame.transform.scale(Wire_6, (64, 64))
Wire_7 = pygame.image.load(path + "assets/Images/Objects/Wire 7.png")
Wire_7 = pygame.transform.scale(Wire_7, (64, 64))
Wire_8 = pygame.image.load(path + "assets/Images/Objects/Wire 8.png")
Wire_8 = pygame.transform.scale(Wire_8, (64, 64))
Wire_9 = pygame.image.load(path + "assets/Images/Objects/Wire 9.png")
Wire_9 = pygame.transform.scale(Wire_9, (64, 64))
Wire_10 = pygame.image.load(path + "assets/Images/Objects/Wire 10.png")
Wire_10 = pygame.transform.scale(Wire_10, (64, 64))
Wire_11 = pygame.image.load(path + "assets/Images/Objects/Wire 11.png")
Wire_11 = pygame.transform.scale(Wire_11, (64, 64))

Random_box_1 = pygame.image.load(path + "assets/Images/Objects/Random Box 1.png")
Random_box_1 = pygame.transform.scale(Random_box_1, (64, 64))
Random_box_2 = pygame.image.load(path + "assets/Images/Objects/Random Box 2.png")
Random_box_2 = pygame.transform.scale(Random_box_2, (64, 64))
Random_box_3 = pygame.image.load(path + "assets/Images/Objects/Random Box 3.png")
Random_box_3 = pygame.transform.scale(Random_box_3, (64, 64))
Random_box_4 = pygame.image.load(path + "assets/Images/Objects/Random Box 4.png")
Random_box_4 = pygame.transform.scale(Random_box_4, (64, 64))

Slime1 = pygame.image.load(path + "assets/Images/Objects/Blue Slime 1.png")
Slime1 = pygame.transform.scale(Slime1, (128, 128))
Slime1_2 = pygame.image.load(path + "assets/Images/Objects/Blue Slime 2.png")
Slime1_2 = pygame.transform.scale(Slime1_2, (128, 128))
Slime1_3 = pygame.image.load(path + "assets/Images/Objects/Blue Slime 3.png")
Slime1_3 = pygame.transform.scale(Slime1_3, (128, 128))
Slime1_4 = pygame.image.load(path + "assets/Images/Objects/Blue Slime 4.png")
Slime1_4 = pygame.transform.scale(Slime1_4, (128, 128))
Slime2 = pygame.image.load(path + "assets/Images/Objects/Pink Slime 1.png")
Slime2 = pygame.transform.scale(Slime2, (128, 128))
Slime2_2 = pygame.image.load(path + "assets/Images/Objects/Pink Slime 2.png")
Slime2_2 = pygame.transform.scale(Slime2_2, (128, 128))
Slime2_3 = pygame.image.load(path + "assets/Images/Objects/Pink Slime 3.png")
Slime2_3 = pygame.transform.scale(Slime2_3, (128, 128))
Slime2_4 = pygame.image.load(path + "assets/Images/Objects/Pink Slime 4.png")
...
Butterfly1 = pygame.image.load(path + "assets/Images/Objects/Butterfly 1 1.png")
Butterfly1 = pygame.transform.scale(Butterfly1, (32, 32))
Butterfly1_2 = pygame.image.load(path + "assets/Images/Objects/Butterfly 1 2.png")
Butterfly1_2 = pygame.transform.scale(Butterfly1_2, (32, 32))
Butterfly1_3 = pygame.image.load(path + "assets/Images/Objects/Butterfly 1 3.png")
Butterfly1_3 = pygame.transform.scale(Butterfly1_3, (32, 32))

web_texture = pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Piece of web.png"), (128, 128))

Bacteria_walk_left = (

	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Bacteria 1.png"), (256, 512)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Bacteria 2.png"), (256, 512)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Bacteria 3.png"), (256, 512)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Bacteria 4.png"), (256, 512)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Bacteria 5.png"), (256, 512)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Bacteria 6.png"), (256, 512))

	)

Screensaver2 = pygame.image.load(path + "assets/Images/Screensavers/Screensaver 2.png")
Screensaver2 = pygame.transform.scale(Screensaver2, (Height * 2, Height))

Heart = pygame.transform.scale(pygame.image.load(path + "assets/Images/Heart.png"), (32, 32))

textures = {

	"Forest": pygame.transform.scale(pygame.image.load(path + "assets/Images/Bioms/Forest.png"), (256, 256)),
	"Desert": pygame.transform.scale(pygame.image.load(path + "assets/Images/Bioms/Desert.png"), (256, 256)),
	"Field": pygame.transform.scale(pygame.image.load(path + "assets/Images/Bioms/Field.png"), (256, 256)),
	"Taiga": pygame.transform.scale(pygame.image.load(path + "assets/Images/Bioms/Taiga.png"), (256, 256)),
	"Swamp": pygame.transform.scale(pygame.image.load(path + "assets/Images/Bioms/Swamp.png"), (256, 256)),
	"Backrooms 0": pygame.transform.scale(pygame.image.load(path + "assets/Images/Bioms/Backrooms 0.png"), (256, 256)),
	"Backrooms 0.2": pygame.transform.scale(pygame.image.load(path + "assets/Images/Bioms/Backrooms 0.2.png"), (256, 256)),
	"Backrooms 1": pygame.transform.scale(pygame.Surface((256, 256)), (256, 256)),

	}

Backrooms_portal_images = (
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 1.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 2.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 3.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 4.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 5.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 6.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 7.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 8.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 9.png"), (256, 256)),
	pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Backrooms portal 10.png"), (256, 256))
)

no_file_texture = pygame.transform.scale(pygame.image.load(path + "assets/Images/No-file texture.png"), (64, 64))

Button_click = pygame.mixer.Sound(path + "assets/Sounds/Button Pressed.mp3")
Stone_breaking1 = pygame.mixer.Sound(path + "assets/Sounds/Stone breaking 1.mp3")
Stone_breaking2 = pygame.mixer.Sound(path + "assets/Sounds/Stone breaking 2.mp3")
Grass_walking1 = pygame.mixer.Sound(path + "assets/Sounds/Grass walking 1.mp3")
Grass_walking2 = pygame.mixer.Sound(path + "assets/Sounds/Grass walking 2.mp3")
Grass_walking3 = pygame.mixer.Sound(path + "assets/Sounds/Grass walking 3.mp3")
Snow_walking1 = pygame.mixer.Sound(path + "assets/Sounds/Snow walking 1.mp3")
Snow_walking2 = pygame.mixer.Sound(path + "assets/Sounds/Snow walking 2.mp3")
Snow_walking3 = pygame.mixer.Sound(path + "assets/Sounds/Snow walking 3.mp3")
Sand_walking1 = pygame.mixer.Sound(path + "assets/Sounds/Sand walking 1.mp3")
Sand_walking2 = pygame.mixer.Sound(path + "assets/Sounds/Sand walking 2.mp3")
Sand_walking3 = pygame.mixer.Sound(path + "assets/Sounds/Sand walking 3.mp3")
Swamp_walking1 = pygame.mixer.Sound(path + "assets/Sounds/Swamp walking 1.mp3")
Swamp_walking2 = pygame.mixer.Sound(path + "assets/Sounds/Swamp walking 2.mp3")
Swamp_walking3 = pygame.mixer.Sound(path + "assets/Sounds/Swamp walking 3.mp3")
Cave_walking1 = pygame.mixer.Sound(path + "assets/Sounds/Cave walking 1.mp3")
Cave_walking2 = pygame.mixer.Sound(path + "assets/Sounds/Cave walking 2.mp3")
Cave_walking3 = pygame.mixer.Sound(path + "assets/Sounds/Cave walking 3.mp3")
Backrooms_lamps = pygame.mixer.Sound(path + "assets/Sounds/Backrooms/1.mp3")
Backrooms_rand_sound_1 = pygame.mixer.Sound(path + "assets/Sounds/Backrooms/Random Sounds/1.mp3")
Pick_an_item = pygame.mixer.Sound(path + "assets/Sounds/Pick an item.mp3")
...
class Object:
	...
	def __setstate__(self, state):
		...
		full_path = (path + self.image_path) if self.add_path else self.image_path
		
		if not os.path.exists(full_path) and "assets/" not in self.image_path:
			repaired_path = self.image_path
			repaired_path = repaired_path.replace("Images/", "assets/Images/")
			repaired_path = repaired_path.replace("Sounds/", "assets/Sounds/")
			repaired_path = repaired_path.replace("Soundtracks/", "assets/Soundtracks/")
			
			repaired_full_path = (path + repaired_path) if self.add_path else repaired_path
			
			if os.path.exists(repaired_full_path):
				self.image_path = repaired_path
	...
	def load_animations(self):
		...
		for direction in directions:
			...
			for frame_num in range(1, 7):
				path_to_image = f"{path}assets/Images/Players/Hiro/Normal/{direction}/{frame_num}.png"
...
class SpiderEnemy(BaseEnemy):
	...
	def __init__(self, x, y):
		...
		super().__init__(
			...
			speed=random.randint(10, 20),
			animation_frames=[
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Spider.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Spider 2.png"), (256, 256))]
		)
		
		self.animation_images = {
			"Left": pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Spider.png"), (256, 256)),
			"Left attack": pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Spider attack.png"), (256, 256)),
			"Right": pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Spider 2.png"), (256, 256)),
			"Right attack": pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Spider 2 attack.png"), (256, 256))}
...
class Bullet:
	...
	def __init__(self, bullet_x: int, bullet_y: int, mouse_x, mouse_y, type: str):
		...
		self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load(path + "assets/Images/Items/" + type + ".png"),
...
class Lever:
	...
	def __init__(self, in_motherboard):
		...
		self.image1 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Lever 1.png"), (64, 64))
		self.image2 = pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Lever 2.png"), (64, 64))
		self.image = self.image1
		self.neigbords = []
		self.num = len(mechanisms)
	...
	def __init__(self, wall_type: str, X, Y, is_door: bool=False):
		...
		if is_door:
			...
			self.images = [
				...
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 1.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 2.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 1 Open.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 2 Open.png"), (256, 256))
			...
			self.images = [
				...
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 1.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 2.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 3.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 4.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 5.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 6.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 7.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 8.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 9.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 10.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + wall_type + " 11.png"), (256, 256))
	...
	def __setstate__(self, state):
		...
		if self.is_door:
			...
			self.images = [
				...
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 1.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 2.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 1 Open.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 2 Open.png"), (256, 256))
			...
			self.images = [
				...
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 1.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 2.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 3.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 4.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 5.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 6.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 7.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 8.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 9.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 10.png"), (256, 256)),
				pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + self.wall_type + " 11.png"), (256, 256))
...
class Motherboard:
	...
	def __init__(self, in_motherboard):
		...
		self.condition = "Off"
		self.image = pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Motherboard.png"), (64, 64))
		self.neigbords = []
		self.neigbords_on = 0
		self.neigbords_none = 0
		self.num = len(mechanisms)
...
class Cave:
	...
	def __init__(self, cave_x, cave_y, w, h):
		...
		self.own_width = w
		self.own_height = h
		self.image = pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Cave.png"), (128, 128))
		self.objects = []
		self.name = "Cave"
		self.generate()
	...
	def generate(self):
		...
		for _ in range(self.own_width // 100 + random.randint(-10, 10)):
			self.objects.append(Object("Stone", random.randint(self.own_width // 2 * -1, self.own_width // 2), random.randint(self.own_height // 2 * -1, self.own_height // 2), "assets/Images/Items/Stone.png"))
			
		for _ in range(self.own_width // 300 + random.randint(-10, 10)):
			self.objects.append(Object("Iron ore", random.randint(self.own_width // 2 * -1, self.own_width // 2), random.randint(self.own_height // 2 * -1, self.own_height // 2), "assets/Images/Objects/Iron ore.png", (256, 256), special_flags=100, is_solid=True))

		for _ in range(self.own_width // 300 + random.randint(-10, 10)):
			self.objects.append(Object("Gold ore", random.randint(self.own_width // 2 * -1, self.own_width // 2), random.randint(self.own_height // 2 * -1, self.own_height // 2), "assets/Images/Objects/Gold ore.png", (256, 256), special_flags=100, is_solid=True))
...
def settings():
	...
	def next_page():
		global page
		page += 1 
	back_button = Button(-20, -20, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)))

	help_button = Button(10, 117, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Help.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Help 2.png"), (132, 64)))
	display_button = Button(10, 192, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Display.png"), (222, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Display 2.png"), (222, 64)))
	languages_button = Button(10, 267, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Languages.png"), (272, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Languages 2.png"), (272, 64)))
	user_button = Button(10, 342, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/User.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/User 2.png"), (132, 64)))
	sound_button = Button(10, 417, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Sound.png"), (160, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Sound 2.png"), (160, 64)))
	statistics_button = Button(10, 492, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Statistics.png"), (300, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Statistics 2.png"), (300, 64)))
	keys_button = Button(10, 567, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Keys.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Keys 2.png"), (132, 64)))
	game_button = Button(10, 642, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Game.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Game 2.png"), (132, 64)))
	
	english_button = Button(385, 198, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/English.png"), (220, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/English 2.png"), (220, 64)))
	russian_button = Button(385, 267, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Russian.png"), (220, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Russian 2.png"), (220, 64)))
	kazach_button = Button(385, 336, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Kazach.png"), (188, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Kazach 2.png"), (188, 64)))

	page_back_button = Button(361, Height - 138, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)), action=page_back)
	page_next_button = Button(Width - 138, Height - 138, pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), True, False), pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)), True, False), action=next_page)

	bigTextInfo = pygame.font.Font(path + "assets/Font.ttf", 36)
	...
	def help():
		...
		while True:
			...
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Help 2.png"), (132, 64)), (10, 117))
			...
			if page == 1:
				...
				win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Items/Furnace.png"), (64, 64)), (385, 509))
				win.blit(Changed_inventory_slot, (465, 509))
				win.blit(Inventory_slot, (545, 509))
				win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Items/Clay.png"), (64, 64)), (545, 509))
				win.blit(Inventory_slot, (625, 509))
				win.blit(Changed_inventory_slot, (1185, 509))
				win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Items/Brick.png"), (64, 64)), (1185, 509))
	...
	def display():
		...
		while True:
			...
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Display 2.png"), (222, 64)), (10, 192))
			languages_button.main(Languages)
			user_button.main(User)
			sound_button.main(Sound)
			statistics_button.main(Statistics)
	...
	def Languages():
		...
		while True:
			...
			help_button.main(help)
			display_button.main(display)
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Languages 2.png"), (272, 64)), (10, 267))
			user_button.main(User)
			sound_button.main(Sound)
			statistics_button.main(Statistics)
			keys_button.main(Keys)
	...
	def User():
		...
		while True:
			...
			display_button.main(display)
			languages_button.main(Languages)
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/User 2.png"), (132, 64)), (10, 342))
			sound_button.main(Sound)
			statistics_button.main(Statistics)
			keys_button.main(Keys)
			game_button.main(Game)
	...
	def Sound():
		...
		while True:
			...
			languages_button.main(Languages)
			user_button.main(User)
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Sound 2.png"), (160, 64)), (10, 417))
			statistics_button.main(Statistics)
			keys_button.main(Keys)
			game_button.main(Game)
	...
	def Statistics():
		...
		while True:
			...
			user_button.main(User)
			sound_button.main(Sound)
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Statistics 2.png"), (300, 64)), (10, 492))
			keys_button.main(Keys)
			game_button.main(Game)
	...
	def Keys():
		...
		while True:
			...
			sound_button.main(Sound)
			statistics_button.main(Statistics)
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Keys 2.png"), (132, 64)), (10, 567))
			game_button.main(Game)
			
			littleTextInfo = pygame.font.Font(path + "assets/Font.ttf", 8)
	...
	def Game():
		...
		while True:
			...
			statistics_button.main(Statistics)
			keys_button.main(Keys)
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Game 2.png"), (132, 64)), (10, 642))
...
def change_a_character():
	...
	back_button = Button(-20, -20, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)))
	character_button = Button(10, 120, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Character.png"), (272, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Character 2.png"), (272, 64)))
	pets_button = Button(10, 192, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Pets.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Pets 2.png"), (132, 64)))
	page_back_button = Button(361, Height - 138, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)))
	page_next_button = Button(Width - 138, Height - 138, pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), True, False), pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)), True, False))
	...
	def characters():
		...
		while True:
			...
			if back_button.get_pressed() or keys[pygame.K_ESCAPE]:
				win_darken(win.copy())
				menu()
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Character 2.png"), (278, 64)), (10, 120))
	...
	def pets():
		...
		while True:
			...
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Pets 2.png"), (132, 64)), (10, 192))
...
def start_game():
	...
	for dirs, folder, files in os.walk(path + "Plugins/"):
		inside_files = files
		break
			...
			match i[0]:
				...
				case "Item":
					...
					try:
						...
						inventory.resources[i[1]] = Resource(i[1], path + "assets/Images/No-file texture.png", [i[3], i[4]], [i[5], i[6]], i[7])
				...
				case "Object":
					...
					try:
						...
						a = Object(i[1], i[3], i[4], "assets/Images/No-file texture.png", special_flags=i[5])
					b = True
					for object in world.visible_objects:
						if a == object:
							b = False
	...
	while True:
				...
				if chat_input:
					...
					if event.key == hot_keys["Throw away the item"] and inventory.whole_inventory[changed_slot] is not None:
						...
						if Backrooms.InBackrooms:
							backrooms_objects.append(Object(inventory.whole_inventory[changed_slot].name, player.x, player.y, "assets/Images/Items/" + inventory.whole_inventory[changed_slot].name + ".png", special_flags="Item"))
						else:
							...
							particles.append(Particle(player.x, player.y, pygame.transform.scale(pygame.image.load(path + "assets/Images/Items/" + inventory.whole_inventory[changed_slot].name + ".png"), (64, 64)), x_bias_, y_bias_, variable_to_calculate="(30 - self.ticks * 2.5, 15 - self.ticks * 4)", track_ticks=True, end_time=0.5, end_command="world.chunk_manager.get_chunk_at(particle.x, particle.y).items.append(Object(particle.special_flags, particle.x, particle.y, 'Images/Items/' + particle.special_flags + '.png', special_flags='Item', pickable=True))", end_command_globals_in_the_end=("world", "Object"), special_flags=inventory.whole_inventory[changed_slot].name))
		...
		if not Backrooms.InBackrooms:
			...
			if game_time > 600 and not night_playing:
				music_channel.stop()
				music_channel.play(pygame.mixer.Sound(path + "assets/Soundtracks/Night " + str(random.randint(1, 2)) + ".mp3"))
				night_playing = True
				...
				match current_biome:
					...
					case "Forest" | "Field":
						music_channel.queue(pygame.mixer.Sound(path + "assets/Soundtracks/Forest " + str(random.randint(1, 3)) + ".mp3"))
						
					case "Desert":
						music_channel.queue(pygame.mixer.Sound(path + "assets/Soundtracks/Desert " + str(random.randint(1, 2)) + ".mp3"))
						
					case "Swamp":
						music_channel.queue(pygame.mixer.Sound(path + "assets/Soundtracks/Swamp " + str(random.randint(1, 2)) + ".mp3"))
						
					case "Taiga":
						music_channel.queue(pygame.mixer.Sound(path + "assets/Soundtracks/Taiga " + str(random.randint(1, 1)) + ".mp3"))
		...
		if not Backrooms.InBackrooms and world.current_cave is None:
			...
			if False: # TODO тут сделать переход в закулисье
				...
				for object in Backrooms.objects:
					i += 1
					backrooms_objects.append(Object(object, Backrooms.objects_x[i], Backrooms.objects_y[i], "assets/Images/Items/" + inventory.resources[object].name + ".png", special_flags="Item"))
		...
		if not Backrooms.InBackrooms:
			...
			if world.current_cave is not None:
				...
				win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Cave.png"), (128, 128)), (0 - player.x + Width // 2 - world.current_cave.w // 2, player.y - 0 + Height // 2 - world.current_cave.h // 2))
							...
							if object.name == "Iron ore" and click[0] and inventory.whole_inventory[changed_slot] is not None and inventory.whole_inventory[changed_slot].name in ("Stone pickaxe"):
								...
								if object.special_flags == -1:
									...
									for i in range(random.randint(1, 3)):
										world.current_cave.objects.append(Object("Iron ore", random.randint(object.x - 128, object.x + 128), random.randint(object.y - 128, object.y + 128), "assets/Images/Items/Iron ore.png", special_flags="Item"))
									break
							...
							if object.name == "Gold ore" and click[0] and inventory.whole_inventory[changed_slot] is not None and inventory.whole_inventory[changed_slot].name in ("Stone pickaxe"):
								...
								if object.special_flags == -1:
									...
									for _ in range(random.randint(1, 3)):
										world.current_cave.objects.append(Object("Gold ore", random.randint(object.x - 128, object.x + 128), random.randint(object.y - 128, object.y + 128), "assets/Images/Items/Gold ore.png", special_flags="Item"))
									break
				...
				for i, object in enumerate(world.visible_objects):
					...
					if object.object_class == "Object":
						...
						if object.x - player.x + Width // 2 - object.image.get_width() // 2 <= mouse_x <= object.x - player.x + Width // 2 + object.image.get_width() // 2 and player.y - object.y + Height // 2 - object.image.get_height() // 2 <= mouse_y <= player.y - object.y + Height // 2 + object.image.get_height() // 2:
							...
							if object.name == "Tree" and click[0]:
								...
								if object.special_flags < 1:
									...
									for _ in range(random.randint(2, 5)):
										...
										world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Wooden", rand_x, rand_y, "assets/Images/Items/Wooden.png"))
							
									for _ in range(random.randint(1, 3)):
										rand_x, rand_y = object.x + random.randint(-128, 128), object.y + random.randint(-128, 128)
										world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Stick", rand_x, rand_y, "assets/Images/Items/Stick.png"))
									break
							...
							if object.name == "Dark tree" and click[0]:
								...
								if object.special_flags <= 0:
									...
									for _ in range(random.randint(2, 5)):
										rand_x, rand_y = object.x + random.randint(-128, 128), object.y + random.randint(-128, 128)
										world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Dark wooden", rand_x, rand_y, "assets/Images/Items/Dark wooden.png"))
							...
							if object.name == "Birch" and click[0]:
								...
								if object.special_flags <= 0:
									...
									for _ in range(random.randint(2, 5)):
										rand_x, rand_y = object.x + random.randint(-128, 128), object.y + random.randint(-128, 128)
										world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Birch wooden", rand_x, rand_y, "assets/Images/Items/Birch wooden.png"))
							...
							if object.name == "Pond":
								...
								if object.special_flags[1] != 0 and inventory.whole_inventory[changed_slot] is not None and inventory.whole_inventory[changed_slot].name == "Stone shovel" and object.get_left_pressed() and random.randint(1, 30) == 1:
									rand_x, rand_y = object.x +random.randint(-128, 128), object.y + random.randint(-128, 128)
									world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Clay", rand_x, rand_y, "assets/Images/Items/Clay.png"))
						...
						if object.name == "Grenade":
							...
							if object.x - 60 < object.special_flags[0] < object.x + 60 and object.y - 60 < object.special_flags[1] < object.y + 60:
										...
										if i.special_flags == -1:
											...
											if i.name in ("Dark tree", "Birch"):
												for i in range(random.randint(2, 5)):
													...
													world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object(i.name + " wooden", rand_x, rand_y, "assets/Images/Items/" + i.name + " wooden.png"))
								...
								for _ in range(150):
									...
									radius -= 0.1
									particles.append(Particle(object.x, object.y, pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Explosion.png"), (100, 100)), x_bias=radius * cos(angle), y_bias=radius * sin(angle), increased_transparency=30, end_time=0.3))
						...
						if object.name == "Dandelion" and time.time() - object.start_time > 1200:
							...
							try:
								object.image_path = path + "assets/Images/Objects/Dandelion " + str(int(object.image_path[-5]) + 1) + ".png"
							...
							if object.image_path[-5] == "5":
								...
								for _ in range(5):
									...
									if random.randint(1, 5) == 1:
										particles.append(Particle(object.x, object.y, pygame.transform.scale(pygame.image.load(path + "assets/Images/Items/Dandelion seed.png"), (32, 32)), random.randint(-30, 30), random.randint(-30, 30), end_time=5, end_command="world.chunk_manager.get_chunk_at(particle.x, particle.y).items.append(Object('Dandelion', particle.x, particle.y, 'Images/Objects/Dandelion 1.png', special_flags='Item'))"))
									else:
										particles.append(Particle(object.x, object.y, pygame.transform.scale(pygame.image.load(path + "assets/Images/Items/Dandelion seed.png"), (32, 32)), random.randint(-30, 30), random.randint(-30, 30), end_time=5))
							...
							if object.get_left_pressed() and inventory.whole_inventory[changed_slot] is not None and inventory.whole_inventory[changed_slot].name in ("Mushroom", "Red mushroom", "Thread", "Poppy", "Purple tulip", "Orange tulip", "Black tulip", "Red tulip", "Yellow tulip", "Dandelion", "Cotton grass", "Onion"):
								if object.special_flags < 11:
									...
									if object.special_flags > 6:
										object.image = pygame.image.load(path + "assets/Images/Objects/Punch " + str(object.special_flags - 5) + ".png")
								else:
									object.special_flags = 1
									world.chunk_manager.get_chunk_at(object.x, object.y).items.append(Object("Punch", object.x, object.y, "assets/Images/Items/Powder.png"))
					...
					if mob.name == "Slime":
						...
						for _ in range(random.randint(1, 3)):
							if mob.slime_type == 1:
								...
								world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Blue slime", rand_x, rand_y, "assets/Images/Items/Blue Slime.png", pickable=True))
							else:
								rand_x, rand_y = mob.x + random.randint(-30, 30), mob.y + random.randint(-30, 30)
								world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Pink slime", rand_x, rand_y, "assets/Images/Items/Pink Slime.png", pickable=True))
						mobs.remove(mob)

					elif mob.name == "Spider":
						rand_x, rand_y = mob.x + random.randint(-30, 30), mob.y + random.randint(-30, 30)
						world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Thread", mob.x + random.randint(-30, 30), mob.y + random.randint(-30, 30), "assets/Images/Items/Thread.png", pickable=True))
						mobs.remove(mob)
		...
		if (inventory.whole_inventory[changed_slot] is not None and (use_item_pressed or (click[0] and Settings["Game"][1]))) and not chat_input:
			...
			match inventory.whole_inventory[changed_slot].name:
				...
				case "Grenade":
					...
					current_chunk.objects.append(Object("Grenade", player.x, player.y, "assets/Images/Items/Grenade.png", special_flags=(player.x + mouse_x - Width // 2, player.y - mouse_y + Height // 2)))
		...
		match weather:
			...
			case "Rain":
				...
				for _ in range(15):
					particles.append(Particle(random.randint(1, Width), -50, pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/Drop.png"), (64, 64)),  x_bias=random.randint(-5, 5) + offset, y_bias=random.randint(30, 40), display_mode=lambda X, Y, w, h: (X, Y), end_y=Height, end_zone=30))
		...
		if Settings["Game"][1]:
			...
			right_b.main()
			if inventory_open:
				win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Open inventory slot.png"), (64, 64)), (890, 10))
				if 890 <= mouse_x <= 954 and 10 <= mouse_y <= 74 and click[0]:
					inventory_open = False
			else:
				win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Slots/Open inventory slot.png"), (64, 64)), (810, 10))
...
Level {Backrooms.Level}""" if Backrooms.InBackrooms else ""), 10, 400 if inventory_open else 300)
		...
		build(build_tuple, Object("Table", 0, 0, "assets/Images/Objects/Table.png", (256, 256), special_flags=1), "Table")
		build(build_tuple, Object("Wall table", 0, 0, "assets/Images/Objects/Wall table.png", (256, 256), special_flags=1), "Wall table")
		build(build_tuple, Object("Furnace", 0, 0, "assets/Images/Items/Furnace.png", (256, 256), special_flags=1), "Furnace")
		build(build_tuple, Object("Punch", 0, 0, "assets/Images/Objects/Punch 1.png", (256, 256), special_flags=1), "Punch")
		
		build(build_tuple, Object("Farmland", 0, 0, "assets/Images/Objects/Farmland.png", (128, 128), special_flags=1), "Stone hoe", get_item_from_inventory=0, command="pygame.mixer.Sound.play(pygame.mixer.Sound('" + path + "assets/Sounds/Dirt.mp3" + "'))")
		...
		try: build(build_tuple, Particle(0, 0, pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + a + " 1.png"), (128, 128)), can_interfere_with_placing=True, end_time=random.randint(1, 3),
...
if self.special_flags[2]:
	...
	if inventory.whole_inventory[changed_slot] is not None and inventory.whole_inventory[changed_slot].name == "Whater bucket" and pygame.Rect(a, b, 128, 128).collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0]:
		...
		pygame.mixer.Sound.play(pygame.mixer.Sound(path + "assets/Sounds/Watering plants " + str(random.randint(1, 2)) + ".mp3"))""", True, """
if particle.special_flags[2]: particles.append(Particle(particle.x, particle.y, pygame.transform.scale(pygame.image.load(path + 'Images/Objects/' + particle.special_flags[0] + ' 4.png'), (128, 128)), can_interfere_with_placing=True, save_particle=True, del_self_condition=lambda particle: (click[0] and pygame.Rect(particle.x - player.x + Width // 2 - particle.image.get_width() // 2, player.y - particle.y + Height // 2 - particle.image.get_height() // 2, particle.w, particle.h).collidepoint(mouse_x, mouse_y)), end_command='pygame.mixer.Sound.play(pygame.mixer.Sound(path + "assets/Sounds/Breaking.mp3"))'))
...
if click[0] and pygame.Rect(self.display_mode(self.x, self.y, self.w, self.h)[0], self.display_mode(self.x, self.y, self.w, self.h)[1], self.w, self.h).collidepoint(mouse_x, mouse_y):
	for _ in range(random.randint(1, 3)):
		...
		world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object(self.special_flags[0], rand_x, rand_y, "assets/Images/Items/" + self.special_flags[0] + ".png"))
	if self.special_flags[0] == "Wheat":
		for _ in range(random.randint(0, 2)):
			rand_x, rand_y = self.x + random.randint(-30, 30), self.y + random.randint(-30, 30)
			world.chunk_manager.get_chunk_at(rand_x, rand_y).items.append(Object("Wheat seeds", rand_x, rand_y, "assets/Images/Items/Wheat seeds.png"))
...
"""]),
		...
		#particles.append(Particle(particle.x, particle.y, pygame.transform.scale(pygame.image.load(path + "assets/Images/Objects/" + particle.special_flags[0] + " 2.png"), (128, 128)), end_time=random.randint(1, 3), save_particle=True, tick_command=particle.special_flags[1], end_command=particle.special_flags[3]))
		
		#particles.append(Particle(particle.x, particle.y, path + "assets/Images/Objects/" + particle.special_flags[0] + " 3.png"))
		...
		if multyplayer_menu_open:
			...
			while multyplayer_menu_open:
				...
				if mouse_x <= 128 and mouse_y <= 128:
					win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)), (0, 0))
					if click[0]:
						multyplayer_menu_open = False
						
				else:
					win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), (0, 0))
		...
		if inventory.whole_inventory[inventory.start_cell] is not None and inventory.start_cell > 0 and hold_left:
			...
			if inventory.whole_inventory[inventory.start_cell].type == "Food":
				win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Heart.png"), (64, 64)), (mouse_x + 20, mouse_y + 65))
...
def edit_world():
	...
	easy_but = Button(50, 200, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Easy.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Easy 2.png"), (132, 64)))
	norm_but = Button(50, 270, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Norm.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Norm 2.png"), (132, 64)))
	hard_but = Button(50, 340, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Hard.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Hard 2.png"), (132, 64)))
	skull_but = Button(50, 410, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Skull.png"), (132, 64)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Skull 2.png"), (132, 64)))
	...
	match difficulty:
		...
		case "easy":
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Easy 2.png"), (132, 64)), (50, 200))
			
		case "norm":
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Norm 2.png"), (132, 64)), (50, 270))
			
		case "hard":
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Hard 2.png"), (132, 64)), (50, 340))
			
		case "skull":
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Skull 2.png"), (132, 64)), (50, 410))
...
def worlds():
	...
	page_back_button = Button(10, Height - 138, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)))
	page_next_button = Button(Width - 148, Height - 148, pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back.png"), (128, 128)), True, False), pygame.transform.flip(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Back 2.png"), (128, 128)), True, False))
				...
				if page < len(inside_folders) / 5 or len(inside_folders) % 5 == 0:
					...
					for i in range((page - 1) * 5, (page - 1) * 5 + 5):
						...
						if 50 + textInfo.size(inside_folders[i])[0] <= mouse_x <= 82 + textInfo.size(inside_folders[i])[0] and 50 + a * 50 <= mouse_y <= 82 + a * 50:
							win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Edit 2.png"), (32, 32)), (50 + textInfo.size(inside_folders[i])[0], 50 + a * 50))
							if click[0]:
						...
						if 50 <= mouse_x <= 50 + textInfo.size(inside_folders[i])[0] and 50 + a * 50 <= mouse_y <= 50 + a * 50 + textInfo.size(inside_folders[i])[1]:
							...
							win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Edit.png"), (32, 32)), (50 + textInfo.size(inside_folders[i])[0], 50 + a * 50))
...
def menu():
	...
	play_button = Button(Width / 2, Height / 2 - 150, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Play.png"), (264, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Play 2.png"), (264, 128)), alignment=True, info="Подсказка: вы можете нажать enter, чтобы сразу начать игру.", action=worlds)
	settings_button = Button(Width / 2, Height / 2, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Settings.png"), (488, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Settings 2.png"), (488, 128)), alignment=True, action=settings)
	change_a_character_button = Button(Width / 2, Height / 2 + 150, pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Change a character.png"), (960, 128)), pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/Change a character 2.png"), (960, 128)), alignment=True, action=change_a_character)
	...
	win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Discord logo.png"), (108, 81)), (Width - 90, Height - 80))
	win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/More.png"), (64, 64)), (Width - 140, Height - 70))
	win_lighten(win.copy())
	...
	while True:
		...
		if Width - 140 < mouse_x < Width - 76 and Height - 70 < mouse_y < Height - 6:
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Buttons/More 2.png"), (64, 64)), (Width - 140, Height - 70))
		...
		if more_menu_open:
			...
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Telegram logo.png"), (100, 100)), (200, Height // 2 + 50))
			text("Telegram\n@Gannitto", 250, Height // 2 + 180, blue_color, alignment=True)
			
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Discord logo.png"), (200, 150)), (Width // 2 - 100, Height // 2 + 30))
			text("Discord\nGannitto#0694", Width // 2, Height // 2 + 180, blue_color, alignment=True)
			
			win.blit(pygame.transform.scale(pygame.image.load(path + "assets/Images/Gmail logo.png"), (100, 100)), (Width - 300, Height // 2 + 50))
			...
			win.blit(pygame.image.load(path + "assets/Images/Rickrolling QR-code.png"), (Width // 2 - 100, Height // 2 - 200))
